...
// configuration step. It creates a namespace called `vndr`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", vndr::cmake::project_name, vndr::cmake::project_version) };
