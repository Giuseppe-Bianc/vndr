...
#define GENERATOR_FULLNAME                                                                                                                 \
    FORMAT("{} v{} git sha: {}", vndr::cmake::project_name, vndr::cmake::project_version, vndr::cmake::git_short_sha)
...
#define GENERATOR_VERSION                                                                                                                  \
    FORMAT("v{} git sha: {}", vndr::cmake::project_version, vndr::cmake::git_short_sha)
